...
import com.lunova.moonbot.core.servold.files.FileService;
import com.lunova.moonbot.core.servold.plugin.PluginService;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

/**
 * Manages the initialization and state of various servold in the bot application. This class is
 * responsible for orchestrating the startup sequence of core servold, such as the MoonBotService
 * and PluginService, and handling any errors that occur during the initialization phase.
 *
 * <p>It utilizes a static initialization pattern to manage the lifecycle of servold and ensure
...
public class ServiceManager {
  ...
  /**
   * Initializes all necessary servold for the bot. This is typically called at the application
