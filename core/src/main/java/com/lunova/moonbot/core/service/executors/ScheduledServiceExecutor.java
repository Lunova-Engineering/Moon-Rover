...
public class ScheduledServiceExecutor extends ScheduledThreadPoolExecutor
     ...
     */
    public ScheduledServiceExecutor(
            int corePoolSize,
     ...
     *
     * <p>This implementation does nothing, but may be customized in subclasses. Note: To properly
     * nest multiple overridings, subclasses should generally invoke {@code super.afterExecute} at
     ...
     * To properly nest multiple overridings, subclasses should generally invoke {@code
