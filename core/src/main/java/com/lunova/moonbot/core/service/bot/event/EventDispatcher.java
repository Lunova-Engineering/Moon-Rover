package com.lunova.moonbot.core.service.bot.event;
...
public class EventDispatcher extends ListenerAdapter {
     ...
     * handling.
     *
     * <p>Each plugin gets a chance to process this event. Plugins are responsible for determining
     * if and how they should respond to the slash command based on their own criteria.
     *
    ...
    public void onSlashCommandInteraction(@NotNull SlashCommandInteractionEvent event) {
        ...
        // but you might enable it if the parent class's behavior is required in future JDA
        // versions.
